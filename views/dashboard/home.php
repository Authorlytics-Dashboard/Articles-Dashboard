...
<section class="homeSection" style="overflow-y: hidden;">
    <header>
        ...
        <div class="logo d-flex">
            <svg width="50px" height="70px" viewBox="0 0 220 265" id="logoSvg">
                ...
                <path class="stroke3" fill="none" stroke="#70353e" stroke-width="32" stroke-dasharray="240" stroke-dashoffset="0" stroke-miterlimit="10" d="M169.8,216.1V79.2c0-17.7-14.5-32.2-32.2-32.2l-52.5,0"/>
